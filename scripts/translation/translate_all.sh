...
for trg in en rm; do
  for model_name in transformer transformer_multilingual transformer_multilingual+sentencepiece transformer_sentencepiece transformer_reconstruction transformer_reconstruction+sentencepiece transformer_distillation; do
